...
project = pytorch_testing_utils.__name__
author = pytorch_testing_utils.__author__
copyright = f"{datetime.now().year}, {author}"
version = release = pytorch_testing_utils.__version__
